...
public class election1 extends election {
	...
	public void ele2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query="select candi,mn,pos from cann where pos='SECRETARY' ";
		...
		btnNewButton.setBounds(109, 374, 121, 36);
		...
		table.setBounds(283, 228, 417, 301);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Class.forName("com.mysql.jdbc.Driver");  
				con=DriverManager.getConnection( "jdbc:mysql://localhost:3306/student","root","root");
				ps=con.prepareStatement("insert into table2(name)values(?)");
