...
public class vicepres extends pres  {
	...
	public void vicepress1() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query="select candi,mn,pos from cann where pos='VICE PRESIDENT' ";
		...
		btnNewButton.setBounds(61, 429, 121, 36);
		...
		lblNewLabel_1_2.setBounds(549, 223, 121, 36);
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Class.forName("com.mysql.jdbc.Driver");  
				con=DriverManager.getConnection( "jdbc:mysql://localhost:3306/student","root","root");
				ps=con.prepareStatement("insert into table4(name)values(?)");
